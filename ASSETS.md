...
| `koala-whack-arcade-loop.wav` | Looping background music | `/manus-storage/koala-whack-arcade-loop-32s_8b9e9f36.wav` | Original 156 BPM royalty-safe instrumental arcade loop; 32s PCM WAV for seamless looping. |
